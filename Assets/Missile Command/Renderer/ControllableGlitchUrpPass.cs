namespace UnityEngine.Rendering.Universal {
    internal class ControllableGlitchUrpPass : ScriptableRenderPass {
        ...
        public ControllableGlitchUrpPass(RenderPassEvent renderPassEvent, Material material, float chromaticGlitch, float frameGlitch, float pixelGlitch, string tag) {
